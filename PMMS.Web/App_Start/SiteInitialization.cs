    ...
    public static partial class SiteInitialization
    {
        public static void ApplicationStart()
        {
            try
            {
                ...
                if (ConfigurationManager.AppSettings.Get("EnableOffline") == "1")
                {
               PavePixel.SiteInitializationSetup.ApplicationStartOffline();

                }
                else
                {
                    PavePixel.SiteInitializationSetup.ApplicationStart();
